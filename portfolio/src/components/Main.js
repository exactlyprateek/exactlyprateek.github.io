		...
		<Container maxW={'7xl'} id="main-container">
			...
			>
				<Stack flex={1} spacing={{ base: 5, md: 10 }}>
					...
					<Text color={'gray.500'}>
						As a team member and Developer my perseverance and the ability to communicate well makes the
						team work more efficiently and boosts productivity also previously being working as a Graphic
						Design Lead at various places have put in a much better place to push out great User
						Experiences.
					</Text>
					<Stack spacing={{ base: 4, sm: 6 }} direction={{ base: 'column', sm: 'row' }}>
						<a href="/PrateekRohilla_Frontend_2022.pdf" target="_blank">
							{' '}
							<Button
								rounded={'full'}
								size={'lg'}
						...
						<Link smooth={true} to={'projects'}>
							...
							<Button
								...
								size={'lg'}
								fontWeight={'normal'}
								// colorScheme={useColorModeValue("blackAlpha", '')}
								px={6}
