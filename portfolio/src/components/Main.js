		...
		<Container maxW={'7xl'} id="main-container">
			...
			>
				<Stack flex={1} spacing={{ base: 5, md: 10 }}>
					...
					<Text color={'gray.500'}>
						Snippy is a rich coding snippets app that lets you create your own code snippets, categorize
						them, and even sync them in the cloud so you can use them anywhere. All that is free!
					</Text>
